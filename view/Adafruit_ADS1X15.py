...
Driver for the ADS7830 analog to digital converter

* Author(s): Liz Clark

Adapted for Blinka (Python on Raspberry Pi)
"""
...
_I2C_ADDR = 0x48  # Utilisé directement sans micropython.const
...
class ADS7830:
    ...
    def read(self, channel: int) -> int:
        """Read ADC value and scale to 16-bit
